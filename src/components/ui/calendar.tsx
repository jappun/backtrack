  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary text-slate-50 hover:bg-primary hover:text-slate-50 focus:bg-primary focus:text-slate-50",
        day_today: "bg-slate-100 text-slate-900 text-slate-50 hover:bg-primary hover:text-slate-50 focus:bg-primary focus:text-slate-50",
        day_outside:
